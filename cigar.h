...
extern "C" {
	...
	void cigar_assign (cigar_t * c, uint32_t * cigar, int32_t n_cigar);
	...
	int32_t cigar2ref_len (int n_cigar, uint32_t * cigar);
	int32_t cigar2qry_len (int n_cigar, uint32_t * cigar);
	int32_t bwa_cigar2ref_len (int n_cigar, uint32_t * cigar);
